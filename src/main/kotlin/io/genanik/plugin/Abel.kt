...
object Abel : PluginBase() {
    ...
    override fun onLoad() {
        ...
        Bot.forEachInstance { miraiBot ->
            // init
            msgTranslateController.init(miraiBot.groups)
            msgRepeatController.init(miraiBot.groups)
            msgTrumpController.init(miraiBot.groups)
